...
def make_mock_lark_client() -> MagicMock:
    ...
    ok_response.data = MagicMock(message_id="msg_test_123", card_id="card_test_456")
    ...
    mock.cardkit.v1.card.acreate = AsyncMock(return_value=ok_response)
    mock.cardkit.v1.card.aid_convert = AsyncMock(return_value=ok_response)
    mock.cardkit.v1.card_element.apatch = AsyncMock(return_value=ok_response)
    mock.cardkit.v1.card_element.acontent = AsyncMock(return_value=ok_response)
    return mock
...
class TestProtocolNegativeCases:
    ...
    def test_missing_send_text_not_replier(self):
        class MissingSendText:
            ...
            async def reply_text(self, message_id, text, in_thread=True): ...
            async def reply_card(self, message_id, card_json, in_thread=True): ...
            async def create_card(self, card_json): ...
            async def send_card_by_id(self, chat_id, card_id): ...
            async def reply_card_by_id(self, message_id, card_id, in_thread=True): ...
            async def get_card_id(self, message_id): ...
            async def stream_append_text(self, card_id, text, sequence): ...
            async def stream_set_status(self, card_id, status_text, sequence): ...
            def build_progress_card(self, status, content, title=""): ...
            def build_streaming_progress_card(self, content="", title=""): ...
